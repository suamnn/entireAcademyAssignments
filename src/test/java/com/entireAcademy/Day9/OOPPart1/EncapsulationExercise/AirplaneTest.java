...
public class AirplaneTest {
    ...
    public void Airplane_HasRequiredMembers() {
        ...
        Constructor<Airplane> constructor = SafeReflection.getConstructor(klass, String.class, Integer.TYPE, Integer.TYPE);
        ...
        assertTrue("getBookedFirstClassSeats() method needs to return type: int", method.getReturnType() == Integer.TYPE);
        ...
        assertTrue("getAvailableFirstClassSeats() method needs to return type: int", method.getReturnType() == Integer.TYPE);
        ...
        assertTrue("getTotalFirstClassSeats() method needs to return type: int", method.getReturnType() == Integer.TYPE);
        ...
        assertTrue("reserveSeats(boolean, int) method needs to return type: boolean", method.getReturnType() == Boolean.TYPE);
    }
    ...
    public void airplaneConstructor() {
    	...
    	try {
	        ...
	        assertTrue("Passed ABC123 into constructor and expected PlaneNumber property to hold ABC123.", "ABC123".equals((String)getPlaneNumber.invoke(airplane)));
	        assertTrue("Passed 2 into constructor and expected TotalFirstClassSeats property to return 2.", 2 == (int)getTotalFirstClassSeats.invoke(airplane));
	        assertTrue("Passed 3 into constructor and expected TotalCoachSeats property to return 3.", 3 == (int)getTotalCoachSeats.invoke(airplane));
	        assertTrue("New planes should initially have 0 booked first class seats.", 0 == (int)getBookedFirstClassSeats.invoke(airplane));
	        assertTrue("New planes should initially have 0 booked coach seats.", 0 == (int)getBookedCoachSeats.invoke(airplane));
		} catch (Exception e) {
    ...
    public void airplaneAvailableSeatsTest() {
    	...
    	try {
	        ...
	        assertTrue("No seats have been booked for first class. There are 2 first class seats, 2 should be available.", 2 == (int)getAvailableFirstClassSeats.invoke(airplane));
	        assertTrue("No seats have been booked for coach. There are 3 coach seats, 3 should be available.", 3 == (int)getAvailableCoachSeats.invoke(airplane));
		} catch (Exception e) {
			fail("Failed to instantiate Airplane");
		}
    }
    ...
    public void airplaneReserveSeatsTest() {
    	...
    	try {
	        ...
	        assertTrue("AvailableFirstClassSeats did not return the correct value.", 1 == (int)getAvailableFirstClassSeats.invoke(airplane));
	        assertTrue("BookedFirstClassSeats did not return the correct value.", 1 == (int)getBookedFirstClassSeats.invoke(airplane));

	        assertTrue("AvailableCoachSeats did not return the correct value.", 1 == (int)getAvailableCoachSeats.invoke(airplane));
	        assertTrue("BookedCoachSeats did not return the correct value.", 2 == (int)getBookedCoachSeats.invoke(airplane));
	        ...
	        assertTrue("reserveSeats should return true if a seat can be booked.", false == firstClassResult);
	        assertTrue("reserveSeats should return true if a seat can be booked.", false == coachResult);

	        assertTrue("AvailableFirstClassSeats did not return the correct value.", 2 == (int)getAvailableFirstClassSeats.invoke(airplane));
	        assertTrue("BookedFirstClassSeats did not return the correct value.", 0 == (int)getBookedFirstClassSeats.invoke(airplane));

	        assertTrue("AvailableCoachSeats did not return the correct value.", 3 == (int)getAvailableCoachSeats.invoke(airplane));
	        assertTrue("BookedCoachSeats did not return the correct value.", 0 == (int)getBookedCoachSeats.invoke(airplane));
		} catch (Exception e) {
			fail("Failed to instantiate Airplane");
		}
    }
