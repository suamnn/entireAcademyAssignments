...
public class TelevisionTest {
    ...
    public void televisionConstructor() {
    	...
    	try {
	        ...
	        assertTrue("New TVs should be turned off by default.", false == (boolean)isOn.invoke(television));
	        assertTrue("New TVs should have the current channel set to 3 by default.", 3 == (int)getCurrentChannel.invoke(television));
	        assertTrue("New TVs should have the current volume set to 2 by default.", 2 == (int)getCurrentVolume.invoke(television));
		} catch (Exception e) {
    ...
    public void televisionTurnOnOffTests() {
    	...
    	try {
	        ...
	        assertTrue("The TV was turned on. CurrentChannel should now be 3.", 3 == (int)getCurrentChannel.invoke(television));
	        assertTrue("The TV was turned on. current volume should now be 2.", 2 == (int)getCurrentVolume.invoke(television));

	        turnOff.invoke(television);
	        assertTrue("The TV was turned off. IsOn should now be false.", false == (boolean)isOn.invoke(television));
    	} catch (Exception e) {
			fail("Failed to instantiate Television");
		}
    }
    ...
    public void televisionChangeChannelTests() {
    	...
    	try {
	        ...
	        assertTrue("The TV was not turned on. CurrentChannel should not have changed.", 3 == (int)getCurrentChannel.invoke(television));
	        
	        turnOn.invoke(television);
	        changeChannel.invoke(television, new Object[] {5});
	        assertTrue("The TV is turned on. The Channel was Changed to 5. CurrentChannel should now be 5.", 5 == (int)getCurrentChannel.invoke(television));
    	} catch (Exception e) {
			fail("Failed to instantiate Television");
		}
    }
    ...
    public void televisionChannelUpTests() {
    	...
    	try {
	        ...
	        assertTrue("ChannelUp should only change if the TV has been turned on.", 3 == (int)getCurrentChannel.invoke(television));
	        
	        turnOn.invoke(television);
	        channelUp.invoke(television);
	        assertTrue("ChannelUp should have incremented CurrentChannel by 1.", 4 == (int)getCurrentChannel.invoke(television));
    	} catch (Exception e) {
			fail("Failed to instantiate Television");
		}
    }
    ...
    public void televisionChannelUpPast18Tests() {
    	...
    	try {
	        ...
	        channelUp.invoke(television);
	        assertTrue("channelUp should have incremented CurrentChannel by 1.", 18 == (int)getCurrentChannel.invoke(television));

	        channelUp.invoke(television);
	        assertTrue("channelUp should not let CurrentChannel go past 18. Reset to 3.", 3 == (int)getCurrentChannel.invoke(television));
    ...
    public void televisionChannelDownTests() {
    	...
    	try {
	        ...
	        assertTrue("channelDown should only change if the TV has been turned on.", 3 == (int)getCurrentChannel.invoke(television));

	        turnOn.invoke(television);
	        changeChannel.invoke(television, new Object[] {5});
	        channelDown.invoke(television);
	        assertTrue("channelDown should have decremented CurrentChannel by 1.", 4 == (int)getCurrentChannel.invoke(television));
    	} catch (Exception e) {
			fail("Failed to instantiate Television");
		}
    }
    ...
    public void televisionChannelDownPast3Tests() {
		...
		try {
	        ...
	        channelDown.invoke(television);
	        assertTrue("channelUp should have decremented CurrentChannel by 1.", 3 == (int)getCurrentChannel.invoke(television));
	
	        channelDown.invoke(television);
	        assertTrue("channelDown should not let CurrentChannel go past 3. Reset to 18.", 18 == (int)getCurrentChannel.invoke(television));
    ...
    public void Television_VolumeTests() {
		...
		try {
	        ...
	        assertTrue("Current volume should only be increased if the TV is on.", 2 == (int)getCurrentVolume.invoke(television));
	        
	        turnOn.invoke(television);
	        raiseVolume.invoke(television);
	        assertTrue("raiseVolume should have incremented current volume by 1.", 3 == (int)getCurrentVolume.invoke(television));

	        lowerVolume.invoke(television);
	        assertTrue("LowerVolume should have decremented current volume by 1.", 2 == (int)getCurrentVolume.invoke(television));
	
	        lowerVolume.invoke(television);
	        assertTrue("LowerVolume should have decremented current volume by 1.", 1 == (int)getCurrentVolume.invoke(television));
	    	
	        lowerVolume.invoke(television);
	        assertTrue("LowerVolume should have decremented current volume by 0.", 0 == (int)getCurrentVolume.invoke(television));
	    	
	        lowerVolume.invoke(television);
	        assertTrue("LowerVolume should not let current volume go below 0.", 0 == (int)getCurrentVolume.invoke(television));
		} catch (Exception e) {
			fail("Failed to instantiate Television");
		}
    }
