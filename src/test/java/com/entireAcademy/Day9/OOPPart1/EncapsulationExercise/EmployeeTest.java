...
public class EmployeeTest {
    ...
    public void employeeConstructor() {
    	...
    	try {
	        ...
	        assertTrue("Passed 1 into constructor and expected EmployeeId property to hold 1.", 1 == (int)getEmployeeId.invoke(employee));
	        assertTrue("Passed Jane into constructor and expected FirstName property to hold Jane.", "Jane".equals((String)getFirstName.invoke(employee)));
	        assertTrue("Passed Smith into constructor and expected LastName property to hold Smith.", "Smith".equals((String)getLastName.invoke(employee)));
	        assertTrue("Passed 100000.00 into constructor and expected AnnualSalary property to hold 100000.00.", 100000.00 == (double)getAnnualSalary.invoke(employee));
		} catch (Exception e) {
    ...
    public void employeeRaiseSalaryTest() {
    	...
    	try {
	        ...
	        assertTrue("Raised salary by 5.5%. Expected to go from 100000.00 to 105500.00", 105500.00 == (double)getAnnualSalary.invoke(employee));
		} catch (Exception e) {
			fail("Failed to instantiate Employee");
		}
    }
