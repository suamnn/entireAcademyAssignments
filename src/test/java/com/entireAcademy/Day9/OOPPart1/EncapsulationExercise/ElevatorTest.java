...
public class ElevatorTest {
    ...
    public void elevatorConstructor() {
    	...
    	try {
	        ...
	        assertTrue("NumberOfLevels should be equal to the argument passed into the Constructor.", 3 == (int)getNumberOfFloors.invoke(elevator));
	        assertTrue("The door should be closed for new elevators.", false == (boolean)isDoorOpen.invoke(elevator));
		} catch (Exception e) {
    ...
    public void elevatorOpenDoorTests() {
    	...
    	try {
	        ...
	        assertTrue("The door should be closed after calling CloseDoor.", false == (boolean)isDoorOpen.invoke(elevator));
		} catch (Exception e) {
			fail("Failed to instantiate Elevator");
		}
    }
    ...
    public void elevatorMoveUpAndDownTests() {
    	...
    	try {
	        ...
	        assertTrue("The elevator should go up to the floor that it was directed to.", 2 == (int)getCurrentFloor.invoke(elevator));
	        
	        openDoor.invoke(elevator);
	        goUp.invoke(elevator, new Object[] {3});
	        assertTrue("The elevator should remain on its current floor if the door is open.", 2 == (int)getCurrentFloor.invoke(elevator));
	        closeDoor.invoke(elevator);
	        
	        goUp.invoke(elevator, new Object[] {3});
	        assertTrue("The elevator should go up to the floor that it was directed to.", 3 == (int)getCurrentFloor.invoke(elevator));
	        ...
	        assertTrue("The elevator should only go up if the desired floor is greater than the current floor.", 3 == (int)getCurrentFloor.invoke(elevator));
	        
	        goDown.invoke(elevator, new Object[] {2});
	        assertTrue("The elevator should go down to the floor that it was directed to.", 2 == (int)getCurrentFloor.invoke(elevator));
	        ...
	        goDown.invoke(elevator, new Object[] {1});
	        assertTrue("The elevator should go down to the floor that it was directed to.", 1 == (int)getCurrentFloor.invoke(elevator));
	        ...
	        assertTrue("The elevator should only go down if the desired floor is less than the current floor.", 1 == (int)getCurrentFloor.invoke(elevator));
