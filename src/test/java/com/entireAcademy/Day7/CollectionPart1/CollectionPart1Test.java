...
public class CollectionPart1Test {
    CollectionPart1Exercise exercises = new CollectionPart1Exercise();
    ...
    public void findLargest() {
        assertEquals("Input: findLargest(new ArrayList<Integer>(Arrays.asList(11, 200, 43, 84, 9917, 4321, 1, 33333, 8997)))",
                Optional.of(33333), exercises.findLargest(new ArrayList<Integer>(Arrays.asList(11, 200, 43, 84, 9917, 4321, 1, 33333, 8997))));

        assertEquals("Input: findLargest(new ArrayList<Integer>(Arrays.asList(987, 1234, 9381, 731, 43718, 8932)))",
                Optional.of(43718), exercises.findLargest(new ArrayList<Integer>(Arrays.asList(987, 1234, 9381, 731, 43718, 8932))));

        assertEquals("Input: findLargest(new ArrayList<Integer>(Arrays.asList(34070, 1380, 81238, 7782, 234, 64362, 627)))",
                Optional.of(81238), exercises.findLargest(new ArrayList<Integer>(Arrays.asList(34070, 1380, 81238, 7782, 234, 64362, 627))));
    }
